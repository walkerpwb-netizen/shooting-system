...
function buildCodexPrompt(prompt: string, jobs: CodexStoredJob[]) {
  ...
  return [
    ...
    "Pierwszy krok kazdego zadania: przeczytaj /home/ubuntu/shooting-system/frontend/AGENTS.md zanim wykonasz jakakolwiek inna komende, analize lub edycje.",
    "Traktuj /home/ubuntu/shooting-system/frontend/AGENTS.md jako twarde zasady pracy dla wszystkich zadan z panelu, szczegolnie commit, push i monitorowanie GitHub Actions po zmianach.",
