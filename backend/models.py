...
class CompetitionStage(Base):
    ...
    popper_points = Column(Integer, nullable=False, default=5, server_default="5")
...
class StageScore(Base):
    ...
    popper_hits = Column(Integer, nullable=False, default=0, server_default="0")
    popper_misses = Column(Integer, nullable=False, default=0, server_default="0")
    mini_popper_hits = Column(Integer, nullable=False, default=0, server_default="0")
    mini_popper_misses = Column(Integer, nullable=False, default=0, server_default="0")
    plate_hits = Column(Integer, nullable=False, default=0, server_default="0")
    plate_misses = Column(Integer, nullable=False, default=0, server_default="0")
    mini_plate_hits = Column(Integer, nullable=False, default=0, server_default="0")
    mini_plate_misses = Column(Integer, nullable=False, default=0, server_default="0")
